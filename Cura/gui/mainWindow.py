...
class mainWindow(wx.Frame):
	def __init__(self):
		...
		super(mainWindow, self).__init__(None, title='MyCura ')
		...
		i = self.fileMenu.Append(-1, ("Reload platform\tF5"))
		...
		i = self.fileMenu.Append(-1, ("Machine settings..."))
		...
		if minecraftImport.hasMinecraft():
			print("min")
			i = toolsMenu.Append(-1, ("Minecraft map import..."))
		...
		i = toolsMenu.Append(-1, ("Copy profile to clipboard"))
		self.Bind(wx.EVT_MENU, self.onCopyProfileClipboard,i)

		toolsMenu.AppendSeparator()
		self.allAtOnceItem = toolsMenu.Append(-1, ("Print all at once"), kind=wx.ITEM_RADIO)
		self.Bind(wx.EVT_MENU, self.onOneAtATimeSwitch, self.allAtOnceItem)
		self.oneAtATime = toolsMenu.Append(-1, ("Print one at a time"), kind=wx.ITEM_RADIO)
		...
		self.menubar.Append(self.machineMenu, ("Machine"))

		expertMenu = wx.Menu()
		i = expertMenu.Append(-1, ("Switch to quickprint..."), kind=wx.ITEM_RADIO)
		self.switchToQuickprintMenuItem = i
		self.Bind(wx.EVT_MENU, self.OnSimpleSwitch, i)

		i = expertMenu.Append(-1, ("Switch to full settings..."), kind=wx.ITEM_RADIO)
		self.switchToNormalMenuItem = i
		self.Bind(wx.EVT_MENU, self.OnNormalSwitch, i)
		expertMenu.AppendSeparator()

		i = expertMenu.Append(-1, ("Open expert settings...\tCTRL+E"))
		self.normalModeOnlyItems.append(i)
		self.Bind(wx.EVT_MENU, self.OnExpertOpen, i)
		expertMenu.AppendSeparator()
		i = expertMenu.Append(-1, ("Run first run wizard..."))
		self.Bind(wx.EVT_MENU, self.OnFirstRunWizard, i)
		self.bedLevelWizardMenuItem = expertMenu.Append(-1, ("Run bed leveling wizard..."))
		self.Bind(wx.EVT_MENU, self.OnBedLevelWizard, self.bedLevelWizardMenuItem)
		self.headOffsetWizardMenuItem = expertMenu.Append(-1, ("Run head offset wizard..."))
	...
	def updateMachineMenu(self):
		...
		self.defaultFirmwareInstallMenuItem = self.machineMenu.Append(-1, ("Install default firmware..."))
		self.Bind(wx.EVT_MENU, self.OnDefaultMarlinFirmware, self.defaultFirmwareInstallMenuItem)

		i = self.machineMenu.Append(-1, ("Install custom firmware..."))
